...
export function ButtonRedirectStatistic(){
    ...
    function click(){
        document.body.fadeOut(200, function () {
            document.location.href = 'http://localhost:8100/adminGetStatistic'
        }).fadeIn(200);
    }
    return <input type='button' value='Статистика' style={buttonStyle}
