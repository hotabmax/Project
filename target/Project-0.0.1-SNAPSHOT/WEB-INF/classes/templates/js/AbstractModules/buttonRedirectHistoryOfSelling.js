...
export function ButtonRedirectHistoryOfSelling(){
    ...
    function click(){
        document.body.fadeOut(200, function () {
            document.location.href = 'http://localhost:8100/adminDeleteHistoryOfSelling'
        }).fadeIn(200);
    }
    return <input type='button' value='История продаж' style={buttonStyle}
