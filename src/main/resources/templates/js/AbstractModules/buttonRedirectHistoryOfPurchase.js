...
export function ButtonRedirectHistoryOfPurchase(){
    ...
    function click(){
        document.body.fadeOut(200, function () {
            document.location.href = 'http://localhost:8100/adminDeleteHistoryOfPurchase'
        }).fadeIn(200);
    }
    return <input type='button' value='История закупок' style={buttonStyle}
