$(document).ready(function (){
    $('#displaybar').append( "<div>" +
        "<form id='formTranzactionDeleteHistoryOfSellingAndAddToStoreage' style='display: inline-block; margin: 10px;'>" +
        "        <input id='buttonTranzactionDeleteHistoryOfSellingAndAddToStoreage' style=' height: 50px; font-size: 16pt; border: 0px; border-radius:10px; background-color: #f8f8f8; padding-right: 5px'" +
        "        type='button' value='Возрат товара из-за брака' onClick='clickTranzactionDeleteHistoryOfSellingAndAddToStoreage()'; onMouseOver='eventMouseOverButtonTranzactionDeleteHistoryOfSellingAndAddToStoreage()'; onMouseOut='eventMouseOutButtonTranzactionDeleteHistoryOfSellingAndAddToStoreage()'>" +
        "        <select name='nameSort' id='selectSortToFindTDProduct' onClick='selectProductTranzactionDeleteHistoryOfSellingAndAddToStoreage()' style='height: 50px; font-size: 16pt; outline: none; border:0px; background-color: #f8f8f8; padding-right: 5px' ></select>" +
...
function eventMouseOverButtonTranzactionDeleteHistoryOfSellingAndAddToStoreage(){
    $('#buttonTranzactionDeleteHistoryOfSellingAndAddToStoreage').css('backgroundColor', '#EEEEEF');
}

function eventMouseOutButtonTranzactionDeleteHistoryOfSellingAndAddToStoreage(){
    $('#buttonTranzactionDeleteHistoryOfSellingAndAddToStoreage').css('backgroundColor', '#f8f8f8');
}

function selectProductTranzactionDeleteHistoryOfSellingAndAddToStoreage() {
    $.ajax( "http://localhost:8100/admin/getTableProductsBySort",{
        type: 'post',
        data: $('#formTranzactionDeleteHistoryOfSellingAndAddToStoreage').serialize(),
        dataType: "json",
        success: function (data) {
...
function clickTranzactionDeleteHistoryOfSellingAndAddToStoreage(){
