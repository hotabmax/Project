...
class FilterAutorizationPageTest {
    ...
    @Test
    void autorizationIfCookieIsNull() {
        ...
        resultForFilterAutorization =
                filterAutorizationPage.autorizationIfCookieIsNull(cookies, key,
                        null, null);

        assertEquals("redirect:/admin", resultForFilterAutorization.getResultPage());

        cookies = null;
        resultForFilterAutorization = filterAutorizationPage.autorizationIfCookieIsNull(cookies, key,
                "Тест", "123");
