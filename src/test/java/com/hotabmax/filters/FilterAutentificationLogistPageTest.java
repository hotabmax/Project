...
@SpringBootTest
class FilterAutentificationLogistPageTest {
    ...
    void autentification() {
        try {
            ...
            cookies[0] = cookie;
            result = filterAutentificationLogistPage.autentification(cookies, key);
            ...
            filterAutentificationLogistPage = new FilterAutentificationLogistPage();
