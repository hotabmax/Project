...
@SpringBootTest
class FilterAutentificationAdminPageTest {
    ...
    void autentification() {
        try {
            ...
            cookies[0] = cookie;
            result = filterAutentificationAdminPage.autentification(cookies, key);
            ...
            filterAutentificationAdminPage = new FilterAutentificationAdminPage();
